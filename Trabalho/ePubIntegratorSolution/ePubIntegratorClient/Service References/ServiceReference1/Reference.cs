...
namespace ePubIntegratorClient.ServiceReference1 {
    ...
    public interface IePubCloud {
        ...
        object[] GetUserStatistics(int userID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IePubCloud/GetUserStatistics", ReplyAction="http://tempuri.org/IePubCloud/GetUserStatisticsResponse")]
        System.Threading.Tasks.Task<object[]> GetUserStatisticsAsync(int userID);
        ...
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(object[]))]
        void RegistereBook(object[] bookinfo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IePubCloud/RegistereBook", ReplyAction="http://tempuri.org/IePubCloud/RegistereBookResponse")]
        System.Threading.Tasks.Task RegistereBookAsync(object[] bookinfo);
        ...
        void RegisterUser(string username, string password, string email, string address, System.DateTime birthdate);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IePubCloud/RegisterUser", ReplyAction="http://tempuri.org/IePubCloud/RegisterUserResponse")]
        System.Threading.Tasks.Task RegisterUserAsync(string username, string password, string email, string address, System.DateTime birthdate);
    ...
    public partial class IePubCloudClient : System.ServiceModel.ClientBase<ePubIntegratorClient.ServiceReference1.IePubCloud>, ePubIntegratorClient.ServiceReference1.IePubCloud {
        ...
        public object[] GetUserStatistics(int userID) {
            return base.Channel.GetUserStatistics(userID);
        }
        
        public System.Threading.Tasks.Task<object[]> GetUserStatisticsAsync(int userID) {
            return base.Channel.GetUserStatisticsAsync(userID);
        }
        ...
        public void RegistereBook(object[] bookinfo) {
            base.Channel.RegistereBook(bookinfo);
        }
        
        public System.Threading.Tasks.Task RegistereBookAsync(object[] bookinfo) {
            return base.Channel.RegistereBookAsync(bookinfo);
        }
        
        public void RegisterUser(string username, string password, string email, string address, System.DateTime birthdate) {
            base.Channel.RegisterUser(username, password, email, address, birthdate);
        }
        
        public System.Threading.Tasks.Task RegisterUserAsync(string username, string password, string email, string address, System.DateTime birthdate) {
